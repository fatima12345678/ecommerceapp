				...
				<div class="col-lg-5 offset-lg-1" style="border:1px solid grey;padding 20px; border-radius:25px;">
					...
					<div class="contact_form_title text-center">Sign In</div>
						...
						@csrf
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" aria-describedby="emailHelp"  required="">
                            </div>
                        ...
                        <a href="{{ route('password.request') }}" class="text-blue">I forgot my password</a> <br>
                        <br>
					...
					<div class="contact_form_title text-center">Sign Up</div>
						...
						<form action="{{ route('register')}}" id="contact_form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control"  aria-describedby="emailHelp" name="password_confirmation" placeholder="Enter your password" required="">
                            </div>
                          	</div> 
							<div class="contact_form_button">

        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <p class="mg-b-20 mg-sm-b-30"> Post Add
                    <a href="{{route('all.blogpost')}}" class="btn btn-sm btn-warning" style="float: right;" >All Post</a>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="post_title_ar"  placeholder="Enter Post Title in Arbic">
                                </div>
                            </div><!-- col-4 -->

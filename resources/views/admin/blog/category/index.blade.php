                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @foreach($blogcat as $key=>$row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('edit/blog/'.$row->id)}}" class="btn btn-sm btn-info">Edit</a>
                                    <a href="{{url('delete/blog/'.$row->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                </td>
                    ...
                    <form method="post" action="{{ route('store.blogcategory') }}">
                        ...
                        <div class="modal-body pd-20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category" name="category_name_ar">

                        ...
                        <div class="top_bar_content ml-auto">
                            ...
                            <li>
                                ...
                                @if(Session::get('lang')=='arbic')
                                        <a href="{{url('english/lang')}}">English<i class="fas fa-chevron-down"></i> </a>
                                 @else
                                        <a href="{{url('arbic/lang')}}">Arbic<i class="fas fa-chevron-down"></i> </a>
                                 @endif
                            ...
                            <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="{{ url('wishlist/user')}}">Wishlist</a></li>
...
<div class="wishlist_icon"><img src="{{asset('frontend/images/heart.png')}}" alt=""></div>
                               <div class="wishlist_content">
                                    <div class="wishlist_text"><a href="{{ url('wishlist/user')}}">Wishlist</a></div>

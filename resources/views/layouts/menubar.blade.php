                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                         @foreach($category as $cat)
                            <li class="hassubs">
                                <a href="{{url('category/view/'.$cat->id)}}">{{$cat->category_name}}<i class="fas fa-chevron-right"></i></a>
                                @php
                                ...
                                @foreach($subcategory as $row)
                                    <li><a href="{{ url('shop/products/'.$row->id)}}">{{ $row->subcategory_name}}<i class="fas fa-chevron-right"></i></a></li>
                                 @endforeach
                                </ul>

                                ...
                                @foreach($featured as $row)
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($row->image_one)}}" alt="" style="width:140px; hieght:120px;"></div>
                                            <div class="product_content">
                                               ...
                                               <div class="product_price discount">${{$row->selling_price}}<span></div>
                                                ...
                                                @else    
                                                <div class="product_price discount"> ${{$row->selling_price}}<span>${{$row->discount_price}}</span></div>
                                                @endif
                                                ...
                                                <div class="product_extras">
                                                 ...
                                                 <!--   <a href="{{ url('add/cart/'.$row->id)}}"> <button class="product_cart_button " data-toggle="modal" data-target="#exampleModalLong">Add to Cart</button></a> -->
                                                 <button id="{{$row->id}}" class="product_cart_button " data-toggle="modal" data-target="#exampleModalLong" onclick="productview(this.id)">Add to Cart</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product_content">
                                               ...
                                               <div class="product_price discount">${{$row->selling_price}}<span></div>
                                                ...
                                                <div class="product_extras">
                                                    ...
                                                    <a href="{{ url('add/cart/'.$row->id)}}"> <button class="product_cart_button">Add to Cart</button></a>
                                                </div>
                                            </div>
                                            <div class="product_fav"><i class="fas fa-heart"></i></div>
                                            <ul class="product_marks">
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_title">{{$row->product_name}}3</div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="{{asset($row->image_one)}}" alt="" style="width:250px; hieght:300px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$catid=$cat->id;
$product=DB::table('products')->where('category_id',$catid)->where('status',1)
                        ...
                        <div class="bestsellers_panel panel active">
                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="{{asset('frontend/images/best_3.pn')}}g" alt=""></div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                        ...
                                        <div class="trends_info clearfix">
                                            ...
                                            @if($row->discount_price == Null)
                                               <div class="product_price discount">${{$row->selling_price}}<span></div>
                                                ...
                                                <div class="product_price discount"> ${{$row->selling_price}}<span>${{$row->discount_price}}</span></div>
                                                @endif
                                                <a href="{{ url('add/cart/'.$row->id)}}" class="btn btn-danger btn-sm">Add to Cart</a>
                                          </div>
                                     </div>
